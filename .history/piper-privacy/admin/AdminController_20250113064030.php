...
use PiperPrivacy\Analytics\Analytics_Manager;
...
class AdminController {
    ...
    public function __construct() {
        $this->analytics_manager = Analytics_Manager::get_instance();
    ...
    public function enqueue_admin_assets() {
        ...
        // Analytics dashboard styles and scripts
        if ($screen->id === 'privacy-manager_page_piper-privacy-analytics') {
            wp_enqueue_style(
                'piper-privacy-analytics',
            ...
            wp_localize_script('piper-privacy-analytics', 'piperPrivacy', [
    ...
    public function render_analytics_page() {
        require_once PIPER_PRIVACY_DIR . 'admin/templates/analytics-dashboard.php';
    }
